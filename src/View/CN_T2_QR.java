...
public class CN_T2_QR extends javax.swing.JFrame {
    ...
    public CN_T2_QR(String maHD, String nguoiTao, int tongTienSP, int giamGia, int thanhToan, JTable tblChiTiet) {
        initComponents();
    ...
    private void AnhQR() {
        try {
            ImageIcon icon = new ImageIcon("src/STOCK_IMG/MaQR.jpg");
